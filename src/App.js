        ...
        <aside className="sm-side">
          <div className="user-head">
            <a className="inbox-avatar" href="#">
              <img width="64" hieght="60" src="http://bootsnipp.com/img/avatars/ebeb306fd7ec11ab68cbcaa34282158bd80361a7.jpg"></img>
            </a>
          ...
          <ul className="nav nav-pills nav-stacked labels-info ">
            ...
            <li>
              <a href="#"> <i className=" fa fa-circle text-success"></i>Alireza Zare
                      <p>I do not think</p>
              </a>
            </li>
            <li>
